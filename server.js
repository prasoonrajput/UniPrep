...
bot.on(message("text"), async (ctx) => {
  ...
  try {
    ...
    const msg =
      "Generate comprehensive answers for given topics, presented in a structured manner with bullet points with full topic explaination in 150 to 200 words . Include types, advantages, disadvantages, and provide illustrative examples for each point, accompanied by detailed explanations";
